    ...
    return (
        <div className="flex h-full shrink-0 items-center">
            ...
            <section className="w-[100vw] h-full relative flex items-center justify-center shrink-0 bg-[#000000] text-white overflow-hidden">
                ...
                <motion.div
                    className="absolute left-[5vw] md:left-[3vw] top-[max(32%,8vh_+_15vw)] z-20"
                    style={{ x: p1ImgX }}
                >
                    <motion.div
                        className="w-[80vw] md:w-[26vw] overflow-hidden"
            ...
            >
                ...
                >
                    ...
                    I am a web developer with a background in architecture, where I developed a strong sense of structure, space, and visual balance.
                </motion.div>
                ...
                <motion.div className="absolute top-[20%] left-[110vw] w-[35vw] md:w-[20vw] z-20 font-['Inter'] text-[10px] md:text-sm leading-relaxed" style={{ x: p3Text1X }}>
                    ...
                    I enjoy creating interactive web experiences that invite users to move through typography, motion, and visual details as if they were exploring a carefully designed space.
                </motion.div>
                ...
                <motion.div className="absolute top-[35%] md:top-[20%] right-[10vw] md:right-[15vw] w-[35vw] md:w-[20vw] z-20 font-['Inter'] text-[10px] md:text-sm leading-relaxed" style={{ x: p3Text2X }}>
                    ...
                    My work focuses on connecting design and code to build digital moments that feel intentional, memorable, and quietly immersive beyond the surface of the screen.
                </motion.div>
