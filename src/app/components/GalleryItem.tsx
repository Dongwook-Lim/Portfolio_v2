...
export function GalleryItem({
  ...
  useAnimationFrame(() => {
    ...
    const zIndex = Math.max(1, Math.round(100 - Math.abs(ratio) * 100));
    ...
    >
      ...
      >
        <img
          ...
          src={data.img}
          alt={data.title}
          className="absolute top-1/2 left-1/2 h-full w-[500%] max-w-none -translate-x-1/2 -translate-y-1/2 object-cover bg-zinc-900 -rotate-90"
          draggable={false}
          onError={(e) => {
            e.currentTarget.src =
